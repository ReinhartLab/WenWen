...
groupAvg.freq = [5 9]; %n in hz, from Gplv_ft_sensor, permutation
%%
...
save(fullfile(Dir.results,['indvPeakF_0.5Hz_' ,[cfg.channel{:}],[cfg.refchannel{:}],txtCell{IsLap+1,1},txtCell{IsdePhase+1,2},txtCell{IsBL+1,3} '.mat']),"Indv")
%% peakF distribution
load(fullfile(Dir.results,['indvPeakF_0.5Hz_' ,[cfg.channel{:}],[cfg.refchannel{:}],txtCell{IsLap+1,1},txtCell{IsdePhase+1,2},txtCell{IsBL+1,3} '.mat']))
...
writetable(Indv,['IndvPeak05Hz' [cfg.channel{:}],[cfg.refchannel{:}],txtCell{IsLap+1,1},txtCell{IsdePhase+1,2},txtCell{IsBL+1,3} '.csv'])
myFigBasic;
