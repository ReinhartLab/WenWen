...
EEG = pop_chanedit(EEG, 'lookup',fullfile(Dir.toolbox,'eeglab2021.1\plugins\dipfit4.3\standard_BESA','standard-10-5-cap385.elp'));
...
EEG = pop_chanedit(EEG, 'changefield',{chanID 'labels' 'TP10'},'lookup',fullfile(Dir.toolbox,'eeglab2021.1\plugins\dipfit4.3\standard_BESA','standard-10-5-cap385.elp'), ...
