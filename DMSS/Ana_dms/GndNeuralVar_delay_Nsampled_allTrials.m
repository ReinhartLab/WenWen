...
IsCorretTrials = 0;%enforced to be 0
        ...
        if isfile(matName)
            ...
            for cond_i = 1:3
                for b = 1:length(tfDat{cond_i})
                    ...
                    dat{sub_i}.behaACC(b,cond_i) = mean(TrlBeha{cond_i}{b}.button_resp_corr,'omitnan');
...
%                 subsAll.alphaChansCorrRT(sub_i,c,:) = corr(tmp_var,tmp_beha,'rows','pairwise');
    ...
    saveas(gca,fullfile(Dir.figs,['DelayBetaVarianceFrontalACC_SampledAT',num2str(Nsamps),num2str(freq.betaFreq(1)),'~',num2str(freq.betaFreq(2)),'Hz',num2str(timeROI.Delay(1)),'~',num2str(timeROI.Delay(2)),'s',[frontalROI{:}],txtCell{IsLap+1,1},txtCell{IsdePhase+1,2},txtCell{IsCorretTrials+1,3},txtCell{IsBL2preDelay+1,4},'.png']))
...
%                text(0.95,0.85,sprintf('mean Rho = %.3f\nt=%.3f\np=%.3f\nd=%.3f',mean(subsAll.betaOccipACCcorr(tmpsubs,cond_i)),stats.tstat(cond_i),p(cond_i),computeCohen_d(subsAll.betaOccipACCcorr(tmpsubs,cond_i),zeros(length(tmpsubs),1),'paired')),'sc','HorizontalAlignment','Right')
%     end
%     saveas(gca,fullfile(Dir.figs,['DelayBetaVarianceOccipACC_SampledAT',num2str(Nsamps),num2str(freq.betaFreq(1)),'~',num2str(freq.betaFreq(2)),'Hz',num2str(timeROI.Delay(1)),'~',num2str(timeROI.Delay(2)),'s',[frontalROI{:}],txtCell{IsLap+1,1},txtCell{IsdePhase+1,2},txtCell{IsCorretTrials+1,3},txtCell{IsBL2preDelay+1,4},'.png']))
    ...
    for cond_i = 1:3
        for gi = 1:2
            ...
            h.Label.Rotation = -90;
            h.Label.Position = h.Label.Position + [1 0 0];
            title([groupStr{gi},condStr{cond_i}],['corr ACC TrlCluster=',num2str(Nsamps)]);
        end
...
%         text(0.95,0.85,sprintf('mean Rho = %.3f\nt=%.3f\np=%.3f',mean(subsAll.alphaFrontalACCcorr(tmpsubs,cond_i)),stats.tstat(cond_i),p(cond_i)),'sc','HorizontalAlignment','Right')
%     end
%     saveas(gca,fullfile(Dir.figs,['DelayAlphaVarianceFrontalACC_SampledAT',num2str(Nsamps),num2str(freq.alphaFreq(1)),'~',num2str(freq.alphaFreq(2)),'Hz',num2str(timeROI.Delay(1)),'~',num2str(timeROI.Delay(2)),'s',[frontalROI{:}],txtCell{IsLap+1,1},txtCell{IsdePhase+1,2},txtCell{IsCorretTrials+1,3},txtCell{IsBL2preDelay+1,4},'.png']))
% 
% 
%     %% OccipAlphaACC
% 
...
%         text(0.95,0.85,sprintf('mean Rho = %.3f\nt=%.3f\np=%.3f',mean(subsAll.alphaOccipACCcorr(tmpsubs,cond_i)),stats.tstat(cond_i),p(cond_i)),'sc','HorizontalAlignment','Right')
%     end
%     saveas(gca,fullfile(Dir.figs,['DelayAlphaVarianceOccipACC_SampledAT',num2str(Nsamps),num2str(freq.alphaFreq(1)),'~',num2str(freq.alphaFreq(2)),'Hz',num2str(timeROI.Delay(1)),'~',num2str(timeROI.Delay(2)),'s',[frontalROI{:}],txtCell{IsLap+1,1},txtCell{IsdePhase+1,2},txtCell{IsCorretTrials+1,3},txtCell{IsBL2preDelay+1,4},'.png']))
%     %% alpha topo
%     figure('Name','DelayVar beha corr topo','Position',[100 20 800 1500]);
% 
%     for cond_i = 1:3
...
%     saveas(gcf,fullfile(Dir.figs,['DelayAlphaVarianceTopo_SampledAT',num2str(Nsamps),'_threshP',num2str(threshP),'_',num2str(freq.alphaFreq(1)),'~',num2str(freq.alphaFreq(2)),'Hz',num2str(timeROI.Delay(1)),'~',num2str(timeROI.Delay(2)),'s',txtCell{IsLap+1,1},txtCell{IsdePhase+1,2},txtCell{IsCorretTrials+1,3},txtCell{IsBL2preDelay+1,4} '.png']))
    ...
    print(fig,fullfile(Dir.figs,['DelayBetaVarianceACCchanN_SampledAT',num2str(Nsamps),num2str(freq.betaFreq(1)),'~',num2str(freq.betaFreq(2)),'Hz',num2str(timeROI.Delay(1)),'~',num2str(timeROI.Delay(2)),'s',[frontalROI{:}],txtCell{IsLap+1,1},txtCell{IsdePhase+1,2},txtCell{IsCorretTrials+1,3},txtCell{IsBL2preDelay+1,4},'.pdf']),'-dpdf','-r300','-bestfit')
...
%     saveas(gca,fullfile(Dir.figs,['DelayBetaVarianceRhoScatterHist_SampledAT',num2str(Nsamps),num2str(freq.betaFreq(1)),'~',num2str(freq.betaFreq(2)),'Hz',num2str(timeROI.Delay(1)),'~',num2str(timeROI.Delay(2)),'s',[frontalROI{:}],txtCell{IsLap+1,1},txtCell{IsdePhase+1,2},txtCell{IsCorretTrials+1,3},txtCell{IsBL2preDelay+1,4},'.png']))
    ...
    for gi = 1:2
        ...
        h.Label.Rotation = -90;
        h.Label.Position = h.Label.Position + [1 0 0];
        title([groupStr{gi},condStr{cond_i},'-highACC'],sprintf('corr ACC TrlCluster=%d, subjN=%d',Nsamps,sum(tmp_upper)));
        ...
        h.Label.Rotation = -90;
        h.Label.Position = h.Label.Position + [1 0 0];
        title([groupStr{gi},condStr{cond_i},'-lowACC'],sprintf('corr ACC TrlCluster=%d, subjN=%d',Nsamps,sum(~tmp_upper)));
    end

    saveas(gcf,fullfile(Dir.figs,['DelayBetaVarianceTopoSplitACC_SampledAT',num2str(Nsamps),num2str(freq.betaFreq(1)),'~',num2str(freq.betaFreq(2)),'Hz',num2str(timeROI.Delay(1)),'~',num2str(timeROI.Delay(2)),'s',txtCell{IsLap+1,1},txtCell{IsdePhase+1,2},txtCell{IsCorretTrials+1,3},txtCell{IsBL2preDelay+1,4} '.png']))
end