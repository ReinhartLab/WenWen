...
for IsBL2preDelay = [0 1]
    ...
    for sub_i = 1:subN
        ...
        for IsCorretTrials = [0 1]
            matName = fullfile(Dir.results,[subname,'_ssDelay',txtCell{IsOcci+1,1},txtCell{IsBL2preDelay+1,2},txtCell{IsCorretTrials+1,3},'_mal.mat']);
    ...
    myFigBasic;
    myColors = crameri('vik',2);% https://www.mathworks.com/matlabcentral/fileexchange/68546-crameri-perceptually-uniform-scientific-colormaps
    lineW = 1.5;
