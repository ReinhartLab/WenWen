...
if subs.rawEEG(sn)
    ...
    badChan2interp.badID = union(tmp1,tmp2);

    labels = {EEG.chanlocs.labels};
    badChan2interp.badChans = labels(badChan2interp.badID);

    tmpbad =  badChan2interp.badID;
    ...
    save(fullfile(Dir.prepro,'postICAinterpChans',[subname,'_postInterp.mat']),'badChan2interp')
    %% rejection
