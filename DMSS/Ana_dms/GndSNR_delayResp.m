...
saveas(gcf,fullfile(Dir.figs,['SNR_delayResp_',[chanROI{:}],num2str(freq.betaFreq(1)),'~',num2str(freq.betaFreq(2)),'Hz_',txtCell{IsLap+1,1},num2str(timeROI.delay(1)),'~',num2str(timeROI.delay(2)),'s',txtCell{IsdePhase+1,2},txtCell{IsCorretTrials+1,3},txtCell{IsBL2preDelay+1,4} '.png']))
