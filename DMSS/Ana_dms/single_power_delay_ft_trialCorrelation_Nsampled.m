function single_power_delay_ft_trialCorrelation_Nsampled(sn,IsLap,IsdePhase,IsCorretTrials,IsBL2preDelay,IsOverwrite)
...
if isfile(set_name)
    ...
    for cond_i = 1:3
        ...
        if IsBL2preDelay
            ...
            clear avgBL
            avgBL(1,:,:) = mean(bl.powspctrm,timedim);% don't squeeze
